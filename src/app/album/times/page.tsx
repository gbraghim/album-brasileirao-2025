...
function Modal({ time, onClose }: { time: typeof TIMES_SERIE_A[TimeId]; onClose: () => void }) {
  return (
...
export default function TimesPage() {
  const [selectedTime, setSelectedTime] = useState<typeof TIMES_SERIE_A[TimeId] | null>(null);
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {Object.entries(TIMES_SERIE_A).map(([id, time]) => (
          <div
            key={id}
